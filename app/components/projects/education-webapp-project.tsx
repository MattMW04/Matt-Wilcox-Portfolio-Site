    ...
    return (
        ...
        >
            <div className="relative overflow-hidden">
                ...
                <Image
                    src={`/EducationWebapp.png`}
                    alt={`Project Education Webapp Thumbnail`}
                    width={400}
                    height={300}
            ...
            <CardHeader>
                <CardTitle className="text-gray-100">Dissertation-  Responsive Education Webapp</CardTitle>
                        ...
                        <TooltipProvider>
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Link href="https://github.com/MattMW04/EducationSite" target="_blank" rel="noopener noreferrer">
                                        <Button
                                            variant="outline"
                                            size="sm"
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Link href="/Projects/EducationWebappProject">
                                        <Button
                                            variant="outline"
                                            size="sm"
                                            className="border-gray-600 text-gray-300 hover:bg-gray-700 hover:text-gray-400 hover:border-gray-400 transition-all duration-300"
